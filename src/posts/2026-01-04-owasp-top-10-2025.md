...
**Prevention**: Apply strict authentication and authorisation checks on all endpoints. Use frameworks that handle access control securely. Ensure your AI tools are using secure access patterns.
